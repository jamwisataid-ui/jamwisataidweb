        ...
        <div className="jam-container relative flex min-h-[980px] flex-col justify-center py-16 sm:min-h-[920px] lg:min-h-[680px] lg:py-14">
          <div className="max-w-[730px]">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a href={whatsappHref("Assalamu’alaikum, saya ingin berkonsultasi mengenai paket perjalanan Jam Wisata.", "Hero")} target="_blank" rel="noopener noreferrer" className="lift-soft sheen-light inline-flex min-h-13 items-center justify-center gap-3 rounded-[14px] border border-white/30 bg-gradient-whatsapp px-6 text-sm font-bold text-white shadow-[0_12px_28px_rgba(37,211,102,.22),inset_0_1px_0_rgba(255,255,255,.28)]"><MessageCircle className="size-4" /> Konsultasi via WhatsApp</a>
            </div>
          </div>
          ...
          <div className="mt-14 rounded-[22px] border border-[#0A1D3A]/8 bg-[#FFFDF8] p-4 text-[#0A1D3A] shadow-[0_26px_70px_rgba(2,18,29,.24)] sm:p-5 lg:mt-16 lg:p-6">
            ...
            {tab === "umrah" ? (
              ...
              <div role="tabpanel" className="mt-4 flex flex-col gap-4 rounded-[14px] bg-[#F7F3E9] p-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a href={whatsappHref("Assalamu’alaikum, saya ingin berkonsultasi mengenai program haji Jam Wisata.", "Hero Search — Haji")} target="_blank" rel="noopener noreferrer" className="lift-soft sheen-light inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-xl bg-gradient-whatsapp px-4 text-xs font-extrabold text-white shadow-[0_8px_22px_rgba(37,211,102,.28),inset_0_1px_0_rgba(255,255,255,.32)]"><MessageCircle className="size-4" /> Konsultasi Haji</a>
              </div>
            )}
          </div>
        </div>
