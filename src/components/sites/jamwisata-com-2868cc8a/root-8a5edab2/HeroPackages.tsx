        ...
        <div className="jam-container relative flex min-h-[980px] flex-col justify-center py-16 sm:min-h-[920px] lg:min-h-[680px] lg:py-14">
          <div className="max-w-[730px]">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a href={whatsappHref("Assalamu’alaikum, saya ingin berkonsultasi mengenai paket perjalanan Jam Wisata.", "Hero")} target="_blank" rel="noopener noreferrer" className="lift-soft sheen-gold inline-flex min-h-13 items-center justify-center gap-3 rounded-[14px] border border-white/30 bg-gradient-whatsapp px-6 text-sm font-bold text-white shadow-[0_12px_28px_rgba(37,211,102,.22),inset_0_1px_0_rgba(255,255,255,.28)]"><MessageCircle className="size-4" /> Konsultasi via WhatsApp</a>
            </div>
          </div>
